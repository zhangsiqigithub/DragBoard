...
public class DragHelper {
    ...
    public void drag(View dragger, int position) {
        ...
        if (bitmap != null && !bitmap.isRecycled()) {
            ...
            RecyclerViewHorizontalDataAdapter.ViewHolder holder = (RecyclerViewHorizontalDataAdapter.ViewHolder) mHorizontalRecyclerView.findViewHolderForAdapterPosition(dragPage);
            if (holder != null && holder.itemView != null && holder.getItemViewType() == RecyclerViewHorizontalDataAdapter.TYPE_CONTENT) {
                mCurrentVerticalView = holder.getRecyclerView();
    ...
    private void updateSlidingVerticalRecyclerView(float x, float y) {
        ...
        if (mPagerPosition != newPage) {
            RecyclerViewHorizontalDataAdapter.ViewHolder holder = (RecyclerViewHorizontalDataAdapter.ViewHolder) mHorizontalRecyclerView.findViewHolderForAdapterPosition(newPage);
            if (holder != null && holder.itemView != null && holder.getItemViewType() == RecyclerViewHorizontalDataAdapter.TYPE_CONTENT) {
     ...
     * @return Adapter
     */
    private RecyclerViewVerticalDataAdapter getCurrentAdapter() {
        return (RecyclerViewVerticalDataAdapter) mCurrentVerticalView.getAdapter();
    }
